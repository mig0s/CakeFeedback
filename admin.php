...
if (version_compare(PHP_VERSION, '5.3.7', '<')) {
    exit("Sorry, Login System does not run on a PHP version smaller than 5.3.7 !");
...
if ($login->isUserLoggedIn() == true) {
    ...
    <div class='container'>
      ...
      <ul class=\"nav nav-tabs\" role=\"tablist\">
        <li class=\"active\"><a href=\"admin.php\">View</a></li>
    ...
    $dbName = "guestbook";
    $table = "test_table";
    mysql_connect($hostname, $username, $password) or die ("Can't connect to the database!");
    mysql_select_db($dbName) or die (mysql_error());
    $query = "SELECT id, name, numb, email, age, enquiry, other, data FROM $table";
